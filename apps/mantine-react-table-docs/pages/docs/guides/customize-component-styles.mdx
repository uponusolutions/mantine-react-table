...
Here is a list of all of the MRT CSS variables that are set in the `:root` of your document once you import the MRT `styles.css` file from `'@uponu-solutions/mantine-react-table'`:
