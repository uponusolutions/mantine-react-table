...
/**
 * @type {import('@uponu-solutions/mantine-react-table').MRT_ColumnDef<User>[]}
 */
const columns = [
  {
    accessorKey: 'id', //you should get type hints for all of your keys if you defined your TData type correctly
...
```ts
import { type MRT_RowData, type MRT_TableOptions } from '@uponu-solutions/mantine-react-table';
