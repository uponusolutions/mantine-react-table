...
The following locales are included and can be imported from `'@uponu-solutions/mantine-react-table/locales/'`:
...
> Note: In some frameworks like Remix, you may need to use a full import path like <br /> `import { MRT_Localization_ES } from '@uponu-solutions/mantine-react-table/locales/es/index.js';` or <br /> `import { MRT_Localization_ES } from '@uponu-solutions/mantine-react-table/locales/es/index.esm.js';` <br />
