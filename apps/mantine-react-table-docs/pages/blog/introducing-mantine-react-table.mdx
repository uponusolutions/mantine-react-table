...
```jsx
import { useMantineReactTable, MantineReactTable } from '@uponu-solutions/mantine-react-table';
//...
...
```jsx
import { MantineReactTable } from '@uponu-solutions/mantine-react-table';
//...
return (
